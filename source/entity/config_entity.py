...
class TrainingPipelineConfig:
    ...
    def __init__(self, timestamp=datetime.now()):
        ...
        self.pipeline_name = constant_train.PIPELINE_NAME
        self.di_dir = os.path.join(self.artifact_dir,constant_train.DI_DIR_NAME)
        self.feature_store_file_path = os.path.join(self.artifact_dir, constant_train.DI_FEATURE_STORE_DIR, constant_train.FILE_NAME)
